...
export function QuickTaskButtons({
  ...
  return (
    <div className="min-w-0 rounded-[22px] border border-amber-200 bg-amber-50/80 p-4 sm:rounded-[28px]">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {tasks.map((task) => (
          <button
            ...
            className="min-h-11 max-w-full break-words rounded-full border border-amber-300 bg-white px-4 py-2 text-sm font-semibold text-amber-900 transition hover:border-amber-400 hover:bg-amber-100 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {task}
          </button>
        ))}
